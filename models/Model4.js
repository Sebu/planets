...
Model4 = function(params) {
    ...
    this.setSpeed2 = function(speed) {
        ...
        if(this.showCurve1) this.addCurve(1, this.sphere[1].curve, this.calcCurve({depth: 1, node: this.planet.mesh}), colors["Hippo"]);
		}
		
    this.update = function() {
        if(this.showCurve0) this.addCurve(0, this.sphere[0].curve, this.calcCurve({depth: 0, node: this.planet.mesh}), colors["Path"]);
        this.updateHippo();
